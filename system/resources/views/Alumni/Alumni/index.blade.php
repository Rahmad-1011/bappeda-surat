                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="">
                                  <button class="btn btn-primary btn-rounded"><i class="mdi mdi-information-outline"></i> Detail</button>
                                </a>
                                <a href="">
                                  <button class="btn btn-warning btn-rounded"><i class="mdi mdi-lead-pencil"></i> Edit</button>
                                </a>
                                <a href="">
                                  <button class="btn btn-danger btn-rounded"><i class="mdi mdi-delete-forever"></i> Hapus</button>
                                </a>
                            </td>
                            <td> {{$alumni->nim}} </td>
                            <td> {{$alumni->nama}} </td>
