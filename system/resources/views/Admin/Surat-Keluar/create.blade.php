                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Data Surat Keluar</h5>
                        ...
                        <div class="modal-body">
                            <div class="card">
                                <div class="card-body">
                                    <div class="x_content">
                                    <br />
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{url('Admin/surat-keluar/simpan')}}" enctype="multipart/form-data">
                                      @csrf
                                      ...
                                      <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                          <label class="col-form-label col-md-6 col-sm-6" for="perihal">Unit Kerja/Bagian/Bidang
                                          </label>
                                      ...
                                      <div class="item form-group">
                                        <div class="col-md-6 col-sm-6 ">
                                          <label class="col-form-label col-md-3 col-sm-3" for="no-surat">Klasifikasi
                                          </label>
                                          <input type="text" id="no-surat" name="klasifikasi" required="required" class="form-control">
                                        </div>
                                      </div>
