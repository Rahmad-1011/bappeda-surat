...
<html lang="en">
  <head>
    ...
    <title>Login Alumni TI POLITAP</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-5 py-5">
                ...
                <h3 class="card-title text-left mb-3">Daftar Admin</h3>
                <form action="{{url('Admin/daftar-admin')}}" method="post">
                  @csrf
                  <div class="form-group">
                    <label>Nama</label>
                    <input type="text" name="nama" class="form-control p_input" required>
                  </div>
                  <div class="form-group">
